                                    ...
                                    <div className="content">
                                        ...
                                        <div className="right">
                                            ...
                                            <div className="info">
                                                ...
                                                {renderReleaseDate(data?.first_air_date, "First Air Date")}

                                                {data.runtime && renderRuntime(data.runtime)}
                                                {data.number_of_episodes && renderNumberOfEpisodes(data.number_of_episodes)}          
                                            </div>
                                                    ...
                                                    <span className="text">
                                                        {data?.created_by?.map(
                                                            (c, i) => (
                                                                <span key={i}>
                                                                    {c.name}
                                                                    {!!data?.created_by &&  data ?.created_by.length - 1 !== i && ", "}
                                                                </span>
                                                            )
                                                        )}
                                                    </span>

...
const SearchResult = () => {
    const [data, setData] = useState<AllDataMovieOrTvDetails | null | undefined>(null);
    ...
    const fetchInitialData = useCallback(() => {
        setLoading(true);
        fetchingDataFromApi<AllDataMovieOrTvDetails>(`/search/multi?query=${query}&page=${pageNum}`)
            .then(response => {
                setData(response);
